    ...
    window.location.href = 'gate-2.html'; 
        ...
        buttons.forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                Generator.updateGate(1, { pilar_bidang: btn.dataset.value, karakteristik_jalur: Generator.getJalur(btn.dataset.value) });
                validate();
        ...
        microContainer.addEventListener('input', () => {
            ...
            Generator.updateGate(1, { micro_inputs: microData, kalimat_baku_compiled: kalimat, gate_1_status: "Lolos" });
            validate();
        });
    }
};
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    Generator.loadDraft();
    Generator.initCategorySelection((pilar) => console.log("Pilar dipilih:", pilar));
    const activeBtn = document.querySelector('.category-btn.active');
    if (activeBtn) {
