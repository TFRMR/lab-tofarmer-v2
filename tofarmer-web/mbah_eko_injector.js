(function() {
    ...
    async function periksaSkenarioMading() {
        ...
        for (const post of semuaPostingan) {
            ...
            // Variabel untuk skenario harus dideklarasikan di awal loop
            let terpicu = false;
            let jenisSkenario = "";

            // Tambahkan logika: Kalau ini mention, JANGAN di-stop meski sudah pernah komen
            // Kita pindahkan pengecekan jenisSkenario setelah ia dideklarasikan
            // Catatan: Karena jenisSkenario di awal masih "", kita butuh info dulu
            // Namun agar tidak error, kita cek dulu mention-nya
            ...
            // CEK ULANG DATABASE DENGAN SKENARIO YANG SUDAH JELAS
